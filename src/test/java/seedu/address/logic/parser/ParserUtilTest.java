...
public class ParserUtilTest {
    ...
    private static final String VALID_CLASSTIMING = "Mon 13:00-14:00";
    private static final String VALID_RATE = "70";
    ...
    public void parseLocation_validValueWithWhitespace_returnsTrimmedLocation() throws Exception {
        ...
        assertEquals(expectedAddress, ParserUtil.parseLocation(addressWithWhitespace));
    }
