...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonTimesTableStorage timesTableStorage =
                new JsonTimesTableStorage(temporaryFolder.resolve("timestable.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(timesTableStorage, userPrefsStorage);
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        // Setup LogicManager with JsonTimesTableIoExceptionThrowingStub
        JsonTimesTableStorage timesTableStorage =
                new JsonTimesTableIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionTimesTable.json"));
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + ADDRESS_DESC_AMY + VALID_PREFIX_NOK + NAME_DESC_NOK + PHONE_DESC_NOK + EMAIL_DESC_NOK
                + ADDRESS_DESC_NOK;
     ...
     */
    private static class JsonTimesTableIoExceptionThrowingStub extends JsonTimesTableStorage {
        private JsonTimesTableIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
